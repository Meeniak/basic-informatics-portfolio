...
document.addEventListener('DOMContentLoaded', () => {
    if (typeof xyPoint !== 'undefined') {
        ...
        console.error("L'array 'xyPoint' non è stato trovato.");
        const canvasWrapper = document.getElementById('canvas-wrapper');
        if(canvasWrapper) {
            canvasWrapper.innerHTML = "<p style='color:red; padding:20px;'>Errore: Dati della lettera (file lettere.js) non trovati.</p>";
        }
    }
});
