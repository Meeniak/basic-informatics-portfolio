...
// --- GIULLARE (CON TRIANGOLO SUL CAPPELLO E SORRISO) ---
class JesterScene extends Scene {
    draw() {
        ...
        // --- MODIFICA RICHIESTA: Triangolo decorativo sul cappello ---
        fill(0);
        noStroke();
        triangle(
        ...
        // Campanelli (disegnati per ultimi per stare sopra al triangolo)
        stroke(0);
        strokeWeight(3);
        fill(255);
