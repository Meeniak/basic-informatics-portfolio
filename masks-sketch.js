(function() {
    ...
    class JesterScene extends Scene {
        draw() {
            ...
            push();
            translate(0, 80); // Spostato più in basso
            ...
            line(0,-150,0,250); // Linea centrale per il viso
            ...
            // Punta sinistra
            beginShape(); vertex(-100, -165); quadraticVertex(-180, -280, -250 + random(-bellWobble, bellWobble), -200); endShape();
            // Punta destra
            beginShape(); vertex(100, -165); quadraticVertex(180, -280, 250 + random(-bellWobble, bellWobble), -200); endShape();
            // Punta centrale
